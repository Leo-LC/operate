    ...
    try {
      const res = await fetch("/api/admin/employees", {
        ...
        body: JSON.stringify({
          ...
          has_thai_bank_account: createForm.has_thai_bank_account || undefined,
          bank_name: createForm.bank_name || undefined,
          bank_account_number: createForm.bank_account_number || undefined,
          bank_account_name: createForm.bank_account_name || undefined,
