...
export async function PATCH(req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const allowed = ["name", "slug", "external_id", "is_active", "address_en", "address_th", "phone", "vat_number", "google_maps_url", "google_sheet_id", "notes", "default_service_charge_pct"] as const;
