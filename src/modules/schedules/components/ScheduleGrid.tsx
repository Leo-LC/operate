    ...
    try {
      const res = await fetch("/api/admin/employees", {
        ...
        body: JSON.stringify({
          ...
          has_thai_bank_account: manageCreateForm.has_thai_bank_account || undefined,
          bank_name: manageCreateForm.bank_name || undefined,
          bank_account_number: manageCreateForm.bank_account_number || undefined,
          bank_account_name: manageCreateForm.bank_account_name || undefined,
